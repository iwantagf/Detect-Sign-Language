...
if __name__ == '__main__':
    ...
    class_weights = dataset.compute_class_weights(train_dataset)
    model = training.train_model(model, train_loader, valid_loader, num_epochs = 35, learning_rate = 1e-4, device = device, class_weights=class_weights)
